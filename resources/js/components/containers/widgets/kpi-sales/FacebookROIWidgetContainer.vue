...
import FacebookWidget from "../../../presenters/widgets/kpi-sales/ROIReport";
import { mapState, mapActions } from 'vuex';

export default {
    name: "FacebookROIWidgetContainer",
    components: {
        FacebookWidget,
        SexyHurricane
    },
    ...
    data() {
        return {
            loadingMsg: 'Loading Facebook/IG ROI Report...',
    ...
    mounted() {
        if(this.report === '') {
            ...
            if(this.loading) {
                ...
                console.log('Mahalo from a mounted FacebookROIWidgetContainer - '+ this.report);
